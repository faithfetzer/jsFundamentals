...
for (whatever in netflix.season1.seasonInfo.episodeInfo) {
    console.log(netflix.season1.seasonInfo.episodeInfo[whatever].episodeName);
}
...
// trying to do all the seasons
console.log('New');

for (seasons in netflix) {
    let currentSeason = seasons;
    console.log(currentSeason);
    for (whatever in netflix.currentSeason.seasonInfo.episodeInfo){
        console.log(whatever);
    //    console.log(netflix.currentSeason.seasonInfo.episodeInfo[whatever].episodeName);
    };
}